...
The library uses a **template-based approach**:
...
2. **At runtime**, the library:
   ...
   - Builds a new data model XML with the user's content
   - Injects all parts into the target document with proper relationships
